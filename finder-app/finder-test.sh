...
username=$(cat /etc/finder-app/conf/username.txt)  # Camino actualizado
...
assignment=$(cat /etc/finder-app/conf/assignment.txt) ## Se actualiza la ubicación de assignment.txt
